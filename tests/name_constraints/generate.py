...
Run this script from tests/name_constraints.  It edits the bottom part of
...
def name_constraints_test(test_name,
    ...
    with open(test_name + '.ee.der', 'wb') as f:
    ...
    with open(test_name + '.ca.der', 'wb') as f:
        f.write(certificate.public_bytes(Encoding.DER))
...
top = top[:top.index('// DO NOT EDIT BELOW: generated by name_constraints/generate.py\n')+1]
